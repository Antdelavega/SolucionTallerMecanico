...
namespace AspTallerMecanico.Controllers
{
    public class TipoServiciosController : Controller
    {
        private readonly AspTallerMecanicoContext _context;

        public TipoServiciosController(AspTallerMecanicoContext context)
        {
            _context = context;
        }
        ...
        {
            return View(_context.TipoServicio
                .Include(c=> c.ServicioMecanicos));
        }
